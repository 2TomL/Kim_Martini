    ...
    Array.from(items).slice(0, 10).forEach(item => {
      ...
      card.innerHTML = `
        <div class="soundcloud-player">
          <iframe width="150" height="150" scrolling="no" frameborder="no" allow="autoplay"
            src="https://w.soundcloud.com/player/?url=${encodeURIComponent(link)}&color=%23ff5500&inverse=false&auto_play=false&show_user=false&hide_related=true&show_comments=false&show_teaser=false">
          </iframe>
        </div>
        <div class="mix-info">
